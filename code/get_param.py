...
def get_params():
	...
	parser.add_argument('--json', default="scenes/R1", type=str, help='path or list of paths to scene json files')
	parser.add_argument('--evaluate', default=False, type=str2bool, help='evaluate during reconstruction')
	...
	parser.add_argument('--min_stiffness', default=None, type=float, help='min stiffness range parameter of cloth (default: same as stiffness)')
...
def get_hyperparam(params):
	if params.net=="SMP_param" or params.net=="SMP_param_a" or params.net=="SMP_param_a_gated" or params.net=="SMP_param_a_gated2" or params.net=="SMP_param_a_gated3" or params.net=="SMP_param_a_gated5":
